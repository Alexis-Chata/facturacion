                                        ...
                                        <div class="col-12 p-4">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <select id="stcliente" wire:model="stcliente" class="form-select">
                                                        ...
                                                        @foreach ($tclientes as $tcliente)
                                                            <option value="{{ $tcliente->id }}">{{ $tcliente->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    @error('stcliente')
                                                ...
                                                @if ($stcliente != '')
                                                    ...
                                                    @endif
                                                    <div class="col-12">
                                                        <label for="cliente_identificacion"
                                                            class="fw-bold">Identificación : <span
                                                                class="text-danger">(*)</span></label>
                                                        <input type="text" id="cliente_identificacion"
                                                            class="form-control" wire:model="cliente.identificacion">
